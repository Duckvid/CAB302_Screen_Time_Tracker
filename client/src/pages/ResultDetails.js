...
//import { format } from 'date-fns'; Not used apparently
...
///// Description /////
/*
This file is the main component for the results page. It contains the logic for displaying the results of the survey.
Main functions:
...
function ResultDetails(props) {
  ...
  let MaWdata = {
    labels: ["Intrinsict", "Identified", "Introjected", "External Motivation"],
    datasets: [
      {
        label: "My Data",
        data: [
  ...
  //////// Data and Options for single line graphs and charts ////////

  //Dataset for the harmonious passion:
  let harmonData = {
    labels: ["",
    ],
    datasets: [
      {
        label: "My Harmonious Passion",
        data: [
  ...
  //Options for the harmonious passion:
  let singleBargraphOptions = {
    indexAxis: "y",
    plugins: {
      legend: {
        labels: isMobile
  ...
  //Dataset for the obsessive passion:
  let obsessData = {
    labels: [""],
    datasets: [
      {
        label: "My Obsessive Passion",
        data: [
  ...
  //Dataset for the Cognitive Flexibility:
  let cognFlexData = {
    labels: [""],
    datasets: [
      {
        label: "My Cognitive Flexibility",
        data: [
          (resultSet.CognitiveFlexibility.Total /
            ResultFeedback.CognitiveFlexibility.Total.scale.max) * 100
        ],
    ...
    datasets: [
      {
        ...
        data: [
          (resultSet.Empathy.Total /
                      ResultFeedback.Empathy.Total.scale.max) * 100
        ],
  ...
  //Dataset for the Need to Achieve

  let needToAchieveData = {
    labels: [""],
    datasets: [
      {
        label: "My Need to Achieve",
        data: [
          (resultSet.Empathy.Total /
            ResultFeedback.Empathy.Total.scale.max) * 100
        ],
  ...
  //Dataset for the Grit

  let gritData = {
    labels: [""],
    datasets: [
      {
        label: "My Grit rating",
        data: [
          (resultSet.Grit.Total /
            ResultFeedback.Grit.Total.scale.max) * 100
        ],
  ...
  let growthOrientationData = {
    labels: [""],
    datasets: [
      {
        label: "My Growth Orientation",
        data: [
          (resultSet.GrowthOrientation.Total /
            ResultFeedback.GrowthOrientation.Total.scale.max) * 100
        ],
  ...
  //Torerance for ambiguity

  let toleranceForAmbiguityData = {
    labels: [""],
    datasets: [
      {
        label: "My Tolerance for Ambiguity",
        data: [
          (resultSet.ToleranceForAmbiguity.Total /
            ResultFeedback.ToleranceForAmbiguity.Total.scale.max) * 100
        ],
    ...
    datasets: [
      {
        ...
        data: [
          ...
          ResultFeedback.Resilience.Total.scale.max) * 100
        ],
  ...
  //Dataset for Growth mindset

  let growthMindsetData = {
    labels: [""],
    datasets: [
      {
        label: "My Growth Mindset",
        data: [
          (resultSet.GrowthMindset.Total /
            ResultFeedback.GrowthMindset.Total.scale.max) * 100
        ],
  ...
  //Dataset for the Rule-breaking

  let ruleBreakingData = {
    labels: [""],
    datasets: [
      {
        label: "My Rule-breaking",
        data: [
          (resultSet.RuleBreaking.Total /
            ResultFeedback.RuleBreaking.Total.scale.max) * 100
        ],
  ...
  //Dataset for the Imposter Syndrome

  let imposterSyndromeData = {
    labels: [""],
    datasets: [
      {
        label: "My Imposter Syndrome",
        data: [
          (resultSet.ImposterSyndrome.Total /
            ResultFeedback.ImposterSyndrome.Total.scale.max) * 100
        ],
  ...
  //////// END Data and Options for single line graphs and charts ////////
  ...
  let growth2Options = {
    ...
    const getDocument = () => {
      ...
      elements.style.transformOrigin = "top left";
      html2canvas(elements, {logging: true, letterRendering: 1, useCORS: true}).then(canvas => {
          const imgWidth = 180;
          ...
          // INITIAL PAGE //
          pdfDOC.setFillColor("#39AC7E");
          pdfDOC.rect(0, 0, 230, 297, "F");
          pdfDOC.setFillColor("white");
          pdfDOC.roundedRect(5, 5, 200, 280, 5, 5, "F");
          
          // Document Footer
          pdfDOC.setFillColor("#d96230");
          pdfDOC.rect(0, 282, 230, 15, "F");
          pdfDOC.setTextColor("white");
          pdfDOC.setFontSize(11);
          pdfDOC.text("© Copyright 2023 - Entremap - All rights reserved.", 5, 291);
          pdfDOC.text("Contact: entremapco@gmail.com", 147, 291);
          
          // Add image to doc
          pdfDOC.addImage(imgData, 'PNG', 15, 15, imgWidth, imgHeight);
         ...
         while (heightremaining >= 0) {
              ...
              pdfDOC.addImage(canvas, 'PNG', 15, position, imgWidth, imgHeight, '', 'FAST');
              heightremaining -= pageHeight;
          }
          ...
          // Process document
          pdfDOC.save("YourMindsetReportDetailed.PDF");
      });
  }
          ...
          >
            ...
            <div>
              ...
              <Grid container spacing={5}>
                <Grid item xs="12" sm="6">
                  ...
                  <Bar data={harmonData} options={singleBargraphOptions}height={isMobile ? 150: 150} width={isMobile? 350 : 700} style={{margin: "auto"}}/>
                </Grid>
                <Grid item xs="12" sm="6">
                  <Typography variant="h6" style={{ textAlign: "center" }}>
                    Obsessive Passion
                  </Typography>
                  <Bar data={obsessData} options={singleBargraphOptions}height={isMobile ? 150: 150} width={isMobile? 350 : 700} style={{margin: "auto"}}/>
                </Grid>
              </Grid>
            </div>
            ...
            <Grid container spacing={3}>
              <Grid item xs="12" sm="4">
                <Typography variant="h5" align="center" color= {isMobile ? "black" : "primary"} style={{ paddingTop: "20px", paddingBottom: "10px" }}>
                  CognitiveFlexibility
                </Typography>
                <Bar data={cognFlexData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              ...
              <Bar data={empathyData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              <Grid item xs="12" sm="8">
                <Typography gutterBottom style={{ paddingTop: "30px" }}>
              ...
              <Bar data={needToAchieveData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              <Grid item xs="12" sm="8">
                <Typography gutterBottom style={{ paddingTop: "30px" }}>
                  {getResponse(
              ...
              <Bar data={gritData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              <Grid item xs="12" sm="8">
              ...
              <Bar data={growthOrientationData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              <Grid item xs="12" sm="8">
                <Typography style={{ paddingTop: "30px" }}>
                  {getResponse(
              ...
              <Bar data={toleranceForAmbiguityData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              <Grid item xs="12" sm="8">
                <Typography style={{ paddingTop: "30px" }}>
                  {getResponse(
              ...
              <Bar data={resilienceData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              <Grid item xs="12" sm="8">
                <Typography style={{ paddingTop: "30px" }}>
              ...
              <Bar data={growthMindsetData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              <Grid item xs="12" sm="8">
              ...
              <Bar data={ruleBreakingData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              <Grid item xs="12" sm="8">
                <Typography style={{ paddingTop: "30px" }}>
                  {getResponse(
              ...
              <Bar data={imposterSyndromeData} options={singleBargraphOptions} height={isMobile ? 100: 200} width={isMobile? 350 : 700} style={{margin: "auto"}} />
              </Grid>
              <Grid item xs="12" sm="8">
                <Typography style={{ paddingTop: "30px" }}>
                  {getResponse(
