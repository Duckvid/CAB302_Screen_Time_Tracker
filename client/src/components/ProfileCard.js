...
///// Description /////
/*
This file is the profile card component. It is used to display the user's profile information on the profile page. This is seen in the 
selection box dispalyed on the profile page and is used to select finished surveys.
Main functions:
- createData: creates a row for the table of completed surveys
- getSurveyResults: gets the results of a survey from the database
- ProviderIcon: displays the icon of the provider the user used to sign up
- ProfileCard: displays the user's profile information and completed surveys
Main files and pages connected to this file include:
- Profile.js: this file is the profile page
- Results.js: this file is the results page
*/
///// End Description /////
